...
INPUT_LEN = 672  # regular_settings['INPUT_LEN']  # Length of input sequence
OUTPUT_LEN = 192  # regular_settings['OUTPUT_LEN']  # Length of output sequence
...
PREPROCESSED_FILE = (
    "checkpoints/BigSTPreprocess/sd_100_672_192/BigSTPreprocess_best_val_MAE.pt"
)
MODEL_ARCH = BigST
