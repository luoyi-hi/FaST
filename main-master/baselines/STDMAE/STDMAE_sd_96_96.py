...
MODEL_PARAM = {
    ...
    "pre_trained_tmae_path": "checkpoints/Mask_TMAE/sd_100_96_96/Mask_TMAE_best_val_loss.pt",
    "pre_trained_smae_path": "checkpoints/Mask_SMAE/sd_100_96_96/Mask_SMAE_best_val_MAE.pt",
    "mask_args": {
        "patch_size": 12,
        "in_channel": 1,
        "embed_dim": 96,
